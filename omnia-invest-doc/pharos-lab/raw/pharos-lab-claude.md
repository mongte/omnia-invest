...
**목표:** PM → BE+FE 병렬 구현 → QA 파이프라인으로 FSD 아키텍처 준수 기능 개발 자동화

**트리거:** pharos-lab 기능 구현, Mock→DB 교체, 버그 수정 등 개발 작업 요청 시 `pharos-dev` 스킬을 사용하라. 단순 질문은 직접 응답 가능.

**변경 이력:**
| 날짜 | 변경 내용 | 대상 | 사유 |
|------|----------|------|------|
| 2026-05-27 | 초기 구성 | 전체 | pharos-lab 하네스 신규 구축 |
