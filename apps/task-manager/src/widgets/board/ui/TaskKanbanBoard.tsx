...
const KanbanColumn = ({ status, tasks }: { status: TaskStatus, tasks: Task[] }) => {
  ...
  return (
    <div className="flex flex-col bg-slate-100 rounded-xl h-full overflow-hidden shadow-sm border border-slate-200/60">
      ...
      <Droppable droppableId={status}>
        {(provided) => (
          <div
            ...
            className="p-4 flex flex-col gap-4 min-h-[600px] transition-all overflow-y-auto"
          >
...
export const TaskKanbanBoard = () => {
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    updateTaskStatus(draggableId, newStatus, selectedProjectId);
  };
